let bussinessarr=[
    {
        "image": "https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_1/IMAGE_1648187121.webp",
    "title": "Important Information For August 24 Stock Trading Strategy",
    "description": "Foreign institutional investors bought shares worth Rs 563 crore on Monday while domestic institutional investors sold shares worth Rs 215 crore",
    "date": "24 August 2022"
    },
    {
        "image": "https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_1/Insurance_1657469695.webp",
    "title": "Travelling Abroad? Here’s How To Choose From Single, Multiple Trip Insurance Plans",
    "description": "When you plan for a trip overseas, you could either go for a single trip or a multiple trip insurance policy, depending specifically on the number of days you intend to spend abroad",
    "date": "2022-08-24"
    },
    {
        "image": "https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_1/IMAGE_1653314696.webp",
    "title": "Take Your Pick: Here Are Top-5 Flexi-Cap Mutual Funds To Choose From",
    "description": "Flexi-cap mutual funds invest in stocks with different market capitalisation, thus generating high returns with low-risk exposure. Here are the top-5 flexi-cap funds to choose from",
    "date": "2022-08-24"
    },
      {
        "image": "https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_1/IMAGE_1661139622.webp",
    ...
    {
        "image": "https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_1/IMAGE_1657206088.webp",
    ...
    {
        "image": "https://imgnew.outlookindia.com/public/uploads/articles/2019/6/18/PR.jpg",
    ...
    {
        "image": "https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_1/IMAGE_1647346050.webp",
    "title": "Government To Approach Capital Market Next Month To Raise Funds For Four Road Projects ",
    "description": "The money will be raised through Infrastructure Investment Trusts (InvITs), and there will be an investment limit of Rs 10 lakh for retail investors",
    "date": "23 August 2022"
    },
    {
        "image": "https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_1/IMAGE_1655780053.webp",
    "title": "Sensex, Nifty Snap Two-Day Fall As Bank, Auto Shares Shine",
    ...
    {
        "image": "https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_1/IMAGE_1656671547.webp",
...
let belowarr=[
    {
        "date": "24 August 2022",
        "image": "https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_3/IMAGE_1661184351.webp",
    "title": "Gold Prices Today: Gold Surges Rs 274, Silver Above Rs 448 Amid Firm Global Cues",
    "description": "In the international market, the gold price surged 0.7 per cent at $1,747 per ounce at 1743 GMT. For the past six sessions, gold has been trading lower to hit...",
    },
    {
        "date": "24 August 2022",
...
import {append} from "../export_bussiness/appendbs.js"
console.log(append)

let cont1 = document.getElementById("upper")
append(bussinessarr,cont1)

let cont2 = document.getElementById("lower")
append2(belowarr,cont2)
function append2(data,cont){
    ...
    image.setAttribute("id","busspic")
    image.src = el.image
    
    let title = document.createElement("h3")
    title.innerText = el.title
    title.setAttribute("class","busstitle")
    let description = document.createElement("p")
    description.setAttribute("class","bussdisc")
    description.innerText = el.description
    
    let date = document.createElement("h2")

    date.innerText = el.date
     date.setAttribute("class","bussdate")
    let div = document.createElement("div")
    div.setAttribute("class" ,"buss")
